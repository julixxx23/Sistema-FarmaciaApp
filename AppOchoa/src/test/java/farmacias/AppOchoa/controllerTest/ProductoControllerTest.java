...
class ProductoControllerTest {
    ...
    @Test
    @DisplayName("GET /api/v1/productos/{id} - Deber├¡a retornar 200 y el JSON del producto")
    ...
    @Test
    @DisplayName("POST /api/v1/productos - Deber├¡a retornar 201 Created")
    ...
    @Test
    @DisplayName("DELETE /api/v1/productos/{id} - Deber├¡a retornar 204 No Content")
